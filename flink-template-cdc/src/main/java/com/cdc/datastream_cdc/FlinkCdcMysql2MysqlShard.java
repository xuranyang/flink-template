 ...
 */
public class FlinkCdcMysql2MysqlShard {
    ...
    public static void main(String[] args) throws Exception {
        //show binary logs;
        //show master status;
        String offsetFile = "binlog.000042";
        //show binlog events  IN 'mysql-bin.000008' FROM 154 ;
        long offsetPos = 926L;  //154 219 504
        // 分表取模的字段
        String modField = "id";
        ...
        MySqlSource<String> mySqlSource = MySqlSource.<String>builder()
                ...
                .tableList("flink_test.cdc_shard_table") // set captured table
                .username("root")
                .password("root00")
...
//        dataStreamSource.print("====>").setParallelism(1);
        ...
        dataStream.addSink(new RichSinkFunction<BinlogRow>() {
            ...
            public Connection createMySQLConncetion() throws SQLException {
                String host = parameterTool.get("mysql.host", "127.0.0.1");
                String port = parameterTool.get("mysql.port", "3306");
                String username = parameterTool.get("mysql.username", "root");
                String password = parameterTool.get("mysql.password", "root00");
                String database = parameterTool.get("mysql.database", "flink_test");
