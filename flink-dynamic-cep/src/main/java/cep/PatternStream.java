...
import static cep.PatternProcessFunctionBuilder.fromFlatSelect;
import static cep.PatternProcessFunctionBuilder.fromSelect;
 ...
 * {link cep.nfa.NFA}. In order to process the detected sequences, the user has to
