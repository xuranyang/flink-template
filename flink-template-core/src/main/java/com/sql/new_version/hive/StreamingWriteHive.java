...
public class StreamingWriteHive {
    public static void main(String[] args) throws Exception {
        ...
        String hiveConfDir = "flink-template-core/src/main/resources"; // a local path
...
//		tEnv.executeSql(hiveSql);
        ...
        String insertSql = "insert into tmp.fs_table SELECT userId, amount, " +
