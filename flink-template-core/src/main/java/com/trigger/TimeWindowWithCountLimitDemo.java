 ...
 * 等价于数量窗口增加最大等待时间限制
 */
public class TimeWindowWithCountLimitDemo {
...
//        dataStreamSource.print();
        ...
        dataStreamSource.timeWindowAll(Time.seconds(10))
                .trigger(new CountTriggerWithTimeout(3, TimeCharacteristic.ProcessingTime))
